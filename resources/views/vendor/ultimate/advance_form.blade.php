       ...
       <!-- start header -->
		<div class="page-header navbar navbar-fixed-top">
            <div class="page-header-inner ">
				...
				<ul class="nav navbar-nav navbar-left in">
					<li><a href="index.htm#" class="menu-toggler sidebar-toggler"><i class="icon-menu"></i></a></li>
				</ul>
                 <form class="search-form-opened" action="index.htm#" method="GET">
                ...
                <div class="top-menu">
                    <ul class="nav navbar-nav pull-right">
                        ...
                        <li class="dropdown language-switch">
                            <a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false"> <img src="{{ asset('package/ultimate/assets/img/flags/gb.png') }}" class="position-left" alt=""> English <span class="fa fa-angle-down"></span>
                            </a>
                            <ul class="dropdown-menu animated tada">
                                <li>
                                    <a class="deutsch"><img src="{{ asset('packages/ultimate/assets/img/flags/de.png') }}" alt=""> Deutsch</a>
                                </li>
                                <li>
                                    <a class="ukrainian"><img src="{{ asset('packages/ultimate/assets/img/flags/ua.png') }}" alt=""> Українська</a>
                                </li>
                                <li>
                                    <a class="english"><img src="{{ asset('packages/ultimate/assets/img/flags/gb.png') }}" alt=""> English</a>
                                </li>
                                <li>
                                    <a class="espana"><img src="{{ asset('packages/ultimate/assets/img/flags/es.png') }}" alt=""> España</a>
                                </li>
                                <li>
                                    <a class="russian"><img src="{{ asset('package/ultimate/assets/img/flags/ru.png') }}" alt=""> Русский</a>
                                </li>
                            </ul>
                        </li>
                        <!-- end language menu -->
                                ...
                                <li>
                                    <ul class="dropdown-menu-list small-slimscroll-style" data-handle-color="#637283">
                                        <li>
                                            <a href="index.htm#">
                                                <span class="photo">
                                                	<img src="{{ asset('packages/ultimate/assets/img/user/user2.jpg') }}" class="img-circle" alt=""> </span>
                                                <span class="subject">
                                        ...
                                        <li>
                                            <a href="index.htm#">
                                                <span class="photo">
                                                	<img src="{{ asset('packages/ultimate/assets/img/user/user3.jpg') }}" class="img-circle" alt=""> </span>
                                                <span class="subject">
                                        ...
                                        <li>
                                            <a href="index.htm#">
                                                <span class="photo">
                                                	<img src="{{ asset('packages/ultimate/assets/img/user/user1.jpg') }}" class="img-circle" alt=""> </span>
                                                <span class="subject">
                                        ...
                                        <li>
                                            <a href="index.htm#">
                                                <span class="photo">
                                                	<img src="{{ asset('packages/ultimate/assets/img/user/user8.jpg') }}" class="img-circle" alt=""> </span>
                                                <span class="subject">
                                        ...
                                        <li>
                                            <a href="index.htm#">
                                                <span class="photo">
                                                	<img src="{{ asset('packages/ultimate/assets/img/user/user5.jpg') }}" class="img-circle" alt=""> </span>
                                                <span class="subject">
                                    ...
                                    <div class="dropdown-menu-footer">
                                        <a href="index.htm#"> All Messages </a>
                                    </div>
                                </li>
                            </ul>
                        </li>
                        <!-- end message dropdown -->
 						...
 						<li class="dropdown dropdown-user">
                            <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                <img alt="" class="img-circle " src="{{ asset('packages/ultimate/assets/img/dp.jpg') }}" />
        ...
        <div class="quick-setting-main">
			...
			<div class="quick-setting display-none">
				...
				<a href="index.htm#" data-theme="white"><span class="head"></span><span class="cont"></span></a>
				<a href="index.htm#" data-theme="dark"><span class="head"></span><span class="cont"></span></a>
				<a href="index.htm#" data-theme="blue"><span class="head"></span><span class="cont"></span></a>
				<a href="index.htm#" data-theme="indigo"><span class="head"></span><span class="cont"></span></a>
				<a href="index.htm#" data-theme="cyan"><span class="head"></span><span class="cont"></span></a>
				<a href="index.htm#" data-theme="green"><span class="head"></span><span class="cont"></span></a>
				<a href="index.htm#" data-theme="red"><span class="head"></span><span class="cont"></span></a>
				</div></li>
             	<li><p class="selector-title">Header Brand color</p></li>
             	<li class="theme-option"><div class="theme-color logo-theme">
             	<a href="index.htm#" data-theme="logo-white"><span class="head"></span><span class="cont"></span></a>
				<a href="index.htm#" data-theme="logo-dark"><span class="head"></span><span class="cont"></span></a>
				<a href="index.htm#" data-theme="logo-blue"><span class="head"></span><span class="cont"></span></a>
				<a href="index.htm#" data-theme="logo-indigo"><span class="head"></span><span class="cont"></span></a>
				<a href="index.htm#" data-theme="logo-cyan"><span class="head"></span><span class="cont"></span></a>
				<a href="index.htm#" data-theme="logo-green"><span class="head"></span><span class="cont"></span></a>
				<a href="index.htm#" data-theme="logo-red"><span class="head"></span><span class="cont"></span></a>
             	</div></li>
             	<li><p class="selector-title">Header color</p></li>
             	<li class="theme-option"><div class="theme-color header-theme">
             	<a href="index.htm#" data-theme="header-white"><span class="head"></span><span class="cont"></span></a>
             	<a href="index.htm#" data-theme="header-dark"><span class="head"></span><span class="cont"></span></a>
             	<a href="index.htm#" data-theme="header-blue"><span class="head"></span><span class="cont"></span></a>
             	<a href="index.htm#" data-theme="header-indigo"><span class="head"></span><span class="cont"></span></a>
             	<a href="index.htm#" data-theme="header-cyan"><span class="head"></span><span class="cont"></span></a>
             	<a href="index.htm#" data-theme="header-green"><span class="head"></span><span class="cont"></span></a>
             	<a href="index.htm#" data-theme="header-red"><span class="head"></span><span class="cont"></span></a>
             	</div></li>
			</ul>
			</div>
		</div>
 				...
 				<div class="sidemenu-container navbar-collapse collapse fixed-menu">
	                <div id="remove-scroll">
	                    <ul class="sidemenu  page-header-fixed" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
	                        ...
	                        <li class="sidebar-user-panel">
	                            <div class="user-panel">
	                                <div class="pull-left image">
	                                    <img src="{{ asset('package/ultimate/assets/img/user/user5.jpg') }}" class="img-circle user-img-circle" alt="User Image" />
	                                </div>
	                                <div class="pull-left info">
	                                    <p> John Smith</p>
	                                    <a href="advance_form"><i class="fa fa-circle user-online"></i><span class="txtOnline"> Online</span></a>
	                                </div>
	                            </div>
	                        </li>
	                        ...
	                        <li class="nav-item">
	                            <a href="index.htm#" class="nav-link nav-toggle"> <i class="material-icons">desktop_mac</i>
	                        ...
	                        <li class="nav-item">
	                            <a href="index.htm#" class="nav-link nav-toggle"> <i class="material-icons">grain</i>
	                        ...
	                        <li class="nav-item">
	                            <a href="index.htm#" class="nav-link nav-toggle"> <i class="material-icons">album</i>
                    ...
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            ...
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li><a class="parent-item" href="index.htm#">Forms</a>&nbsp;<i class="fa fa-angle-right"></i>
                                </li>
                        ...
                        <div class="col-md-6 col-sm-6">
                            <div class="card box">
                                ...
                                <div class="card-body" id="bar-parent">
                                    <form id="my-awesome-dropzone" action="javascript:if(confirm('http://radixtouch.in/target\n\nThis file was not retrieved because it was filtered out by your project settings.\n\nWould you like to open it from the server?'))window.location='http://radixtouch.in/target'" class="dropzone form-horizontal"></form>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-6">
	                            ...
	                            <div class="chat-sidebar-chat-users slimscroll-style" data-rail-color="#ddd" data-wrapper-class="chat-sidebar-list">
	                                ...
	                                <ul class="media-list list-items">
	                                    <li class="media">
	                                        ...
	                                        </div> <img class="media-object" src="{{ asset('package/ultimate/assets/img/user/user6.jpg') }}" width="35" height="35" alt="...">
	                                    ...
	                                    <li class="media"><img class="media-object" src="{{ asset('package/ultimate/assets/img/user/user8.jpg') }}" width="35" height="35" alt="...">
	                                        <i class="offline dot"></i>
	                                        <div class="media-body">
