	                        ...
	                        <li class="sidebar-user-panel">
	                            <div class="user-panel">
	                                ...
	                                <div class="pull-left info">
	                                    <p> John Smith</p>
	                                    <a href="index.htm#"><i class="fa fa-circle user-online"></i><span class="txtOnline"> Online</span></a>
	                                </div>
	                            </div>
	                        </li>
                    ...
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            ...
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li><a class="parent-item" href="index.htm#">Email</a>&nbsp;<i class="fa fa-angle-right"></i>
                                </li>
			                                ...
			                                <div class="inbox-body">
			                                    <div class="inbox-header">
			                                        ...
			                                        <div class="mail-option">
			                                            <div class="btn-group">
			                                                <a class="btn" href="index.htm#"> Reply </a> 
			                                                <a class="btn" href="index.htm#"> Reply all </a> 
			                                            </div>
			                                            <div class="btn-group">
			                                                <a class="btn" href="index.htm#"> Forward </a> 
			                                                <a class="btn" href="index.htm#"> Delete </a>
			                                            </div>
			                                            <div class="btn-group">
			                                                <a class="btn" href="index.htm#"> Mark as read </a> 
			                                            </div>
			                                        </div>
			                                    </div>
			                                    <div class="inbox-body no-pad">
			                                        <section class="mail-list">
			                                            <div class="mail-sender">
			                                                ...
			                                                <hr>
															<div class="media">
																<a href="index.htm#" class="pull-left"> <img alt=""
			                                            ...
			                                            <div class="view-mail">
			                                                ...
			                                                <p>
			                                                    Porttitor eu consequat risus. <a href="index.htm#">Mauris sed
			                                                ...
			                                                <p>
			                                                    Sodales <a href="index.htm#">vulputate urna, vel accumsan augue
			                                            ...
			                                            <div class="attachment-mail">
			                                                <p>
			                                                    <span><i class="fa fa-paperclip"></i> 2 attachments
																	— </span> <a href="index.htm#">Download all attachments</a> | <a href="index.htm#">View
																	all images</a>
			                                                </p>
			                                                <ul>
			                                                    <li>
			                                                        <a class="atch-thumb" href="index.htm#"> <img src="assets/img/user/user10.jpg" alt="image upload" class="doctor-pic">
			                                                        </a> <a class="name" href="index.htm#"> IMG_001.jpg <span>20KB</span>
																</a>
			                                                        <div class="links">
			                                                            <a href="index.htm#">View</a> - <a href="index.htm#">Download</a>
			                                                        </div>
			                                                    </li>
			                                                    <li>
			                                                        <a class="atch-thumb" href="index.htm#"> <img src="assets/img/user/user5.jpg" alt="image upload" class="doctor-pic">
			                                                        </a> <a class="name" href="index.htm#"> IMG_001.jpg <span>20KB</span>
																</a>
			                                                        <div class="links">
			                                                            <a href="index.htm#">View</a> - <a href="index.htm#">Download</a>
