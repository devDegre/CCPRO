...
return [
    ...
    */
    ...
    'styles' => [
        ...
        "https://fonts.googleapis.com/css?family=Taviraj:800&display=swap",
        ...
        '../../fonts.googleapis.com/css-family=Poppins-300,400,500,600,700.htm',
        //<!-- icons -->
        'packages/ultimate/assets/plugins/simple-line-icons/simple-line-icons.min.css',
        'packages/ultimate/assets/plugins/font-awesome/css/font-awesome.min.css',
        'packages/ccpro/onglet.css',
        //<!--bootstrap -->
        //'packages/ultimate/assets/plugins/bootstrap/css/bootstrap.min.css',
        //<!-- data tables -->
       // 'packages/ultimate/assets/plugins/datatables/plugins/bootstrap/dataTables.bootstrap4.min.css',
        //<!-- Material Design Lite CSS -->
       // 'packages/ultimate/assets/plugins/material/material.min.css',
       // 'packages/ultimate/assets/css/material_style.css',
       // <!-- animation -->
       // 'packages/ultimate/assets/css/pages/animate_page.css',
        //<!-- Theme Styles -->
        
       'packages/ultimate/assets/css/style.css',
      //  'packages/ultimate/assets/css/plugins.min.css',
      'packages/ultimate/assets/css/responsive.css',
       // 'packages/ultimate/assets/css/theme-color.css',
        //<!-- favicon -->
       // 'packages/ultimate/assets/img/favicon.ico.htm',
    ...
    'body_class' => 'app aside-menu-fixed sidebar-lg-slow',
    ...
    'scripts' => [
      ...
      //   'https://unpkg.com/@coreui/coreui/dist/js/coreui.min.js',
       ...
       // 'packages/ultimate/assets/plugins/jquery/jquery.min.js',
        //'packages/ultimate/assets/plugins/popper/popper.min.js',
       // 'packages/ultimate/assets/plugins/jquery-blockui/jquery.blockui.min.js',
        //'packages/ultimate/assets/plugins/jquery-slimscroll/jquery.slimscroll.min.js',
        //'packages/ultimate/assets/plugins/counterup/jquery.waypoints.min.js',
       // 'packages/ultimate/assets/plugins/counterup/jquery.counterup.min.js',
        //<!-- bootstrap -->
        'packages/ultimate/assets/plugins/bootstrap/js/bootstrap.min.js',
        //<!-- data tables -->
        'packages/ultimate/assets/plugins/datatables/jquery.dataTables.min.js',
        'packages/ultimate/assets/plugins/datatables/plugins/bootstrap/dataTables.bootstrap4.min.js',
        'packages/ultimate/assets/js/pages/table/table_data.js',
        //<!-- Common js-->
       'packages/ultimate/assets/js/app.js',
        'packages/ultimate/assets/js/layout.js',
       // 'packages/ultimate/assets/js/theme-color.js',
        //<!-- Material -->
        'packages/ultimate/assets/plugins/material/material.min.js',
        'packages/ccpro/jquery.css',
        //<!-- animation -->
       // 'packages/ultimate/assets/js/pages/ui/animations.js',
